...
class CrcHash4964(_values.OpenIntEnum):
...
class Coordinates4967(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = (
        "NAVM/1:Geometry/payload/1:Pathing Cell/2:Parent/variants/0:Coordinates"
    )
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "grid_y": _base.Binding(
            path=(
                "NAVM/1:Geometry/payload/1:Pathing Cell/2:Parent/varian"
                "ts/0:Coordinates/0:Grid Y"
            ),
            kind="primitive",
            name="Grid Y",
        ),
...
_VARIANT_4967: _base.Variant = _base.Variant(
    path=(
        "NAVM/1:Geometry/payload/1:Pathing Cell/2:Parent/variants/0:Coordinates"
    )
)
...
_VARIANT_4970: _base.Variant = _base.Variant(
    path=(
        "NAVM/1:Geometry/payload/1:Pathing Cell/2:Parent/variants/1:Parent Cell"
    )
)


class PathingCell4963(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM/1:Geometry/payload/1:Pathing Cell"
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "crc_hash": _base.Binding(
            path="NAVM/1:Geometry/payload/1:Pathing Cell/0:CRC Hash",
            kind="primitive",
            name="CRC Hash",
        ),
        "parent_worldspace": _base.Binding(
            path=("NAVM/1:Geometry/payload/1:Pathing Cell/1:Parent Worldspace"),
            kind="primitive",
            name="Parent Worldspace",
        ),
        "parent": _base.Binding(
            path="NAVM/1:Geometry/payload/1:Pathing Cell/2:Parent",
            kind="union",
            name="Parent",
        ),
    }

    crc_hash: CrcHash4964
    """Value decoded from this schema node."""
    ...
    parent: (
        Annotated[Coordinates4967, _VARIANT_4967]
        | Annotated[_values.FormId, _VARIANT_4970]
    )
    """Value decoded from this schema node."""

    @overload
    def field(self, name: Literal["crc_hash"]) -> _base.FieldRef[CrcHash4964]:
        """Returns the typed field reference."""
...
class Vertex4972(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM/1:Geometry/payload/2:Vertices/element"
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "x": _base.Binding(
            path="NAVM/1:Geometry/payload/2:Vertices/element/0:X",
            kind="primitive",
            name="X",
        ),
        "y": _base.Binding(
            path="NAVM/1:Geometry/payload/2:Vertices/element/1:Y",
            kind="primitive",
            name="Y",
        ),
        "z": _base.Binding(
            path="NAVM/1:Geometry/payload/2:Vertices/element/2:Z",
            kind="primitive",
            name="Z",
        ),
    }
...
class CoverFlags4985(enum.IntFlag):
    """Named values from the pinned schema."""

    EDGE_0_1_COVER_VALUE_1_4 = 1
    EDGE_0_1_COVER_VALUE_2_4 = 2
    EDGE_0_1_COVER_VALUE_3_4 = 4
    EDGE_0_1_COVER_VALUE_4_4 = 8
    EDGE_0_1_LEFT = 16
    EDGE_0_1_RIGHT = 32
    EDGE_1_2_COVER_VALUE_1_4 = 64
    EDGE_1_2_COVER_VALUE_2_4 = 128
    EDGE_1_2_COVER_VALUE_3_4 = 256
    EDGE_1_2_COVER_VALUE_4_4 = 512
    EDGE_1_2_LEFT = 1024
    EDGE_1_2_RIGHT = 2048
    UNKNOWN_13 = 4096
    UNKNOWN_14 = 8192
...
class Triangle4977(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM/1:Geometry/payload/3:Triangles/element"
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "vertex_0": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/0:Vertex 0"),
            kind="primitive",
            name="Vertex 0",
        ),
        "vertex_1": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/1:Vertex 1"),
            kind="primitive",
            name="Vertex 1",
        ),
        "vertex_2": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/2:Vertex 2"),
            kind="primitive",
            name="Vertex 2",
        ),
        "edge_0_1": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/3:Edge 0-1"),
            kind="primitive",
            name="Edge 0-1",
        ),
        "edge_1_2": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/4:Edge 1-2"),
            kind="primitive",
            name="Edge 1-2",
        ),
        "edge_2_0": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/5:Edge 2-0"),
            kind="primitive",
            name="Edge 2-0",
        ),
        "flags": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/6:Flags"),
            kind="primitive",
            name="Flags",
        ),
        "cover_flags": _base.Binding(
            path=("NAVM/1:Geometry/payload/3:Triangles/element/7:Cover Flags"),
            kind="primitive",
            name="Cover Flags",
        ),
    }

    vertex_0: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    vertex_1: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    vertex_2: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    edge_0_1: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    edge_1_2: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    edge_2_0: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    flags: Flags4984
    """Value decoded from this schema node."""

    cover_flags: CoverFlags4985
    """Value decoded from this schema node."""

    @overload
    def field(
        self, name: Literal["vertex_0"]
    ) -> _base.FieldRef[
        Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    ]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(self, name: Literal["flags"]) -> _base.FieldRef[Flags4984]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(
        self, name: Literal["cover_flags"]
    ) -> _base.FieldRef[CoverFlags4985]:
        """Returns the typed field reference."""
...
class Type4988(_values.OpenIntEnum):
    """Named values from the pinned schema."""
...
class EdgeLink4987(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM/1:Geometry/payload/4:Edge Links/element"
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "type": _base.Binding(
            path=("NAVM/1:Geometry/payload/4:Edge Links/element/0:Type"),
            kind="primitive",
            name="Type",
        ),
        "navmesh": _base.Binding(
            path=("NAVM/1:Geometry/payload/4:Edge Links/element/1:Navmesh"),
            kind="primitive",
            name="Navmesh",
        ),
        "triangle": _base.Binding(
            path=("NAVM/1:Geometry/payload/4:Edge Links/element/2:Triangle"),
            kind="primitive",
            name="Triangle",
        ),
    }
    ...
    triangle: Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    """Value decoded from this schema node."""

    @overload
    def field(self, name: Literal["type"]) -> _base.FieldRef[Type4988]:
        """Returns the typed field reference."""
...
class CrcHash4994(_values.OpenIntEnum):
    """Named values from the pinned schema."""
...
class DoorTriangle4992(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = (
        "NAVM/1:Geometry/payload/5:Door Triangles/element"
    )
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "triangle_before_door": _base.Binding(
            path=(
                "NAVM/1:Geometry/payload/5:Door Triangles/element/0:Tri"
                "angle before door"
            ),
            kind="primitive",
        ...
        "crc_hash": _base.Binding(
            path=(
                "NAVM/1:Geometry/payload/5:Door Triangles/element/1:CRC Hash"
            ),
            kind="primitive",
            name="CRC Hash",
        ),
        "door_ref": _base.Binding(
            path=(
                "NAVM/1:Geometry/payload/5:Door Triangles/element/2:Door Ref"
            ),
            kind="primitive",
            name="Door Ref",
        ),
    ...
    triangle_before_door: Annotated[
        int, pydantic.Field(strict=True, ge=-32768, le=32767)
    ]
    """Value decoded from this schema node."""

    crc_hash: CrcHash4994
    """Value decoded from this schema node."""
    ...
    @overload
    def field(
        self, name: Literal["triangle_before_door"]
    ) -> _base.FieldRef[
        Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)]
    ]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(self, name: Literal["crc_hash"]) -> _base.FieldRef[CrcHash4994]:
        """Returns the typed field reference."""
...
class Structure4961(_base.StructModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM/1:Geometry/payload"
    _grammar: ClassVar[bool] = False
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "version": _base.Binding(
            path="NAVM/1:Geometry/payload/0:Version",
            kind="primitive",
            name="Version",
        ),
        "pathing_cell": _base.Binding(
            path="NAVM/1:Geometry/payload/1:Pathing Cell",
            kind="struct",
            name="Pathing Cell",
        ),
        "vertices": _base.Binding(
            path="NAVM/1:Geometry/payload/2:Vertices",
            kind="array",
            name="Vertices",
        ),
        "triangles": _base.Binding(
            path="NAVM/1:Geometry/payload/3:Triangles",
            kind="array",
            name="Triangles",
        ),
        "edge_links": _base.Binding(
            path="NAVM/1:Geometry/payload/4:Edge Links",
            kind="array",
            name="Edge Links",
        ),
        "door_triangles": _base.Binding(
            path="NAVM/1:Geometry/payload/5:Door Triangles",
            kind="array",
            name="Door Triangles",
        ),
        "cover_triangles": _base.Binding(
            path="NAVM/1:Geometry/payload/6:Cover Triangles",
            kind="array",
            name="Cover Triangles",
        ),
        "nav_mesh_grid_divisor": _base.Binding(
            path="NAVM/1:Geometry/payload/7:NavMeshGrid Divisor",
            kind="primitive",
            name="NavMeshGrid Divisor",
        ),
        "max_x_distance": _base.Binding(
            path="NAVM/1:Geometry/payload/8:Max X Distance",
            kind="primitive",
            name="Max X Distance",
        ),
        "max_y_distance": _base.Binding(
            path="NAVM/1:Geometry/payload/9:Max Y Distance",
            kind="primitive",
            name="Max Y Distance",
        ),
        "min_x": _base.Binding(
            path="NAVM/1:Geometry/payload/10:Min X",
            kind="primitive",
            name="Min X",
        ),
        "min_y": _base.Binding(
            path="NAVM/1:Geometry/payload/11:Min Y",
            kind="primitive",
            name="Min Y",
        ),
        "min_z": _base.Binding(
            path="NAVM/1:Geometry/payload/12:Min Z",
            kind="primitive",
            name="Min Z",
        ),
        "max_x": _base.Binding(
            path="NAVM/1:Geometry/payload/13:Max X",
            kind="primitive",
            name="Max X",
        ),
        "max_y": _base.Binding(
            path="NAVM/1:Geometry/payload/14:Max Y",
            kind="primitive",
            name="Max Y",
        ),
        "max_z": _base.Binding(
            path="NAVM/1:Geometry/payload/15:Max Z",
            kind="primitive",
            name="Max Z",
        ),
        "nav_mesh_grid": _base.Binding(
            path="NAVM/1:Geometry/payload/16:NavMeshGrid",
            kind="array",
            name="NavMeshGrid",
        ),
    }

    version: Annotated[int, pydantic.Field(strict=True, ge=0, le=4294967295)]
    """Value decoded from this schema node."""

    pathing_cell: PathingCell4963
    """Value decoded from this schema node."""

    vertices: tuple[Vertex4972, ...]
    """Value decoded from this schema node."""

    triangles: tuple[Triangle4977, ...]
    """Value decoded from this schema node."""

    edge_links: tuple[EdgeLink4987, ...]
    """Value decoded from this schema node."""

    door_triangles: tuple[DoorTriangle4992, ...]
    """Value decoded from this schema node."""

    cover_triangles: tuple[
        Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)], ...
    ]
    """Value decoded from this schema node."""

    nav_mesh_grid_divisor: Annotated[
    ...
    ) -> _base.FieldRef[PathingCell4963]:
        """Returns the typed field reference."""
    ...
    ) -> _base.FieldRef[tuple[Vertex4972, ...]]:
        """Returns the typed field reference."""
    ...
    ) -> _base.FieldRef[tuple[Triangle4977, ...]]:
        """Returns the typed field reference."""
    ...
    ) -> _base.FieldRef[tuple[EdgeLink4987, ...]]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(
        self, name: Literal["door_triangles"]
    ) -> _base.FieldRef[tuple[DoorTriangle4992, ...]]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(
        self, name: Literal["cover_triangles"]
    ) -> _base.FieldRef[
        tuple[
            Annotated[int, pydantic.Field(strict=True, ge=-32768, le=32767)],
            ...,
    ...
    @overload
    def field(
        self, name: Literal["nav_mesh_grid_divisor"]
    ) -> _base.FieldRef[
        Annotated[int, pydantic.Field(strict=True, ge=0, le=4294967295)]
    ]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(self, name: Literal["max_x_distance"]) -> _base.FieldRef[float]:
        """Returns the typed field reference."""

        ...

    @overload
    def field(self, name: Literal["max_y_distance"]) -> _base.FieldRef[float]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(
        self, name: Literal["nav_mesh_grid"]
    ) -> _base.FieldRef[
        tuple[
            tuple[
                Annotated[
...
class NavmeshRecord(_base.RecordModel, frozen=True):
    """Schema-generated immutable structural view."""

    _schema_path: ClassVar[str] = "NAVM"
    _grammar: ClassVar[bool] = True
    signature: ClassVar[str] = "NAVM"
    schema_sha256: ClassVar[str] = (
        "66998fb3c765fbe4b29059c6d68722d1b53a1951b0ab300ff530ca19104104c7"
    )
    _bindings: ClassVar[dict[str, _base.Binding]] = {
        "editor_id": _base.Binding(
            path="NAVM/0:Editor ID",
            kind="subrecord",
            name="Editor ID",
        ),
        "geometry": _base.Binding(
            path="NAVM/1:Geometry",
            kind="subrecord",
            name="Geometry",
        ),
        "base_objects": _base.Binding(
            path="NAVM/2:Base Objects",
            kind="subrecord",
            name="Base Objects",
        ),
        "preferred_connectors": _base.Binding(
            path="NAVM/3:Preferred Connectors",
            kind="subrecord",
            name="Preferred Connectors",
        ),
        "non_connectors": _base.Binding(
            path="NAVM/4:Non Connectors",
            kind="subrecord",
            name="Non Connectors",
        ),
    }
    ...
    geometry: Optional[Structure4961] = None
    """Value decoded from this schema node."""

    base_objects: Optional[tuple[_values.FormId, ...]] = None
    """Value decoded from this schema node."""

    preferred_connectors: Optional[
        tuple[Annotated[int, pydantic.Field(strict=True, ge=0, le=65535)], ...]
    ] = None
    """Value decoded from this schema node."""

    non_connectors: Optional[
        tuple[Annotated[int, pydantic.Field(strict=True, ge=0, le=65535)], ...]
    ] = None
    """Value decoded from this schema node."""
    ...
    @overload
    def field(
        self, name: Literal["geometry"]
    ) -> _base.FieldRef[Optional[Structure4961]]:
        """Returns the typed field reference."""
    ...
    @overload
    def field(
        self, name: Literal["base_objects"]
    ...
    @overload
    def field(
        self, name: Literal["preferred_connectors"]
    ) -> _base.FieldRef[
        Optional[
            tuple[
    ...
    @overload
    def field(
        self, name: Literal["non_connectors"]
    ) -> _base.FieldRef[
        Optional[
            tuple[
                Annotated[int, pydantic.Field(strict=True, ge=0, le=65535)], ...
