...
class TestStringTable:
    ...
    def test_get_str_strips_null_and_decodes(
        ...
        mocker.patch("ctypes.string_at", return_value=b"Iron Sword\x00")
        mocker.patch("bethkit._ffi.load_lib", return_value=mock_lib)
    ...
    def test_closed_table_raises_on_get(self, mocker: MockerFixture) -> None:
    ...
    def test_kind_returns_string_file_kind(self, mocker: MockerFixture) -> None:
    ...
    def test_write_to_file_calls_native(
        ...
        """Delegates file serialization to the native table writer."""
